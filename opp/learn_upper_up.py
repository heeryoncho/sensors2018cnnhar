...
This code learns UP position activity classification model using UPPER body sensors data.
'''
...
if not os.path.exists('fig/model_upper_up.png'):
    model_file = 'fig/model_upper_up.png'
...
'''
/usr/bin/python2.7 /home/hcilab/Documents/OSS/sensors2018cnnhar/opp/learn_upper_up.py
