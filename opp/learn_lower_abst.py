...
This code learns ABSTract activity classification model using LOWER body sensors data.
'''
...
seed(2017)
model = Sequential()
model.add(Conv1D(30, 2, input_shape=(156, 1), activation='relu', kernel_initializer=k_init))
...
if not os.path.exists('fig/model_lower_abst.png'):
    model_file = 'fig/model_lower_abst.png'
...
'''
/usr/bin/python2.7 /home/hcilab/Documents/OSS/sensors2018cnnhar/opp/learn_lower_abst.py
...
=================================================================
conv1d_1 (Conv1D)            (None, 155, 30)           90        
_________________________________________________________________
conv1d_2 (Conv1D)            (None, 154, 50)           3050      
_________________________________________________________________
conv1d_3 (Conv1D)            (None, 153, 100)          10100     
_________________________________________________________________
conv1d_4 (Conv1D)            (None, 152, 300)          60300     
_________________________________________________________________
conv1d_5 (Conv1D)            (None, 151, 500)          300500    
_________________________________________________________________
flatten_1 (Flatten)          (None, 75500)             0         
_________________________________________________________________
dense_1 (Dense)              (None, 2)                 151002    
_________________________________________________________________
dropout_1 (Dropout)          (None, 2)                 0         
=================================================================
Total params: 525,042
Trainable params: 525,042
