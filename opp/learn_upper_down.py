...
This code learns DOWN position activity classification model using UPPER body sensors data.
'''
...
seed(2017)
model = Sequential()
model.add(Conv1D(100, 3, input_shape=(216, 1), activation='relu', kernel_initializer=k_init))
...
if not os.path.exists('fig/model_upper_down.png'):
    model_file = 'fig/model_upper_down.png'
...
'''
/usr/bin/python2.7 /home/hcilab/Documents/OSS/sensors2018cnnhar/opp/learn_upper_down.py
...
=================================================================
conv1d_1 (Conv1D)            (None, 214, 100)          400       
_________________________________________________________________
max_pooling1d_1 (MaxPooling1 (None, 212, 100)          0         
_________________________________________________________________
conv1d_2 (Conv1D)            (None, 210, 500)          150500    
_________________________________________________________________
flatten_1 (Flatten)          (None, 105000)            0         
_________________________________________________________________
dense_1 (Dense)              (None, 2)                 210002    
_________________________________________________________________
