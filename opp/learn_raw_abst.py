...
if not os.path.exists('fig/model_raw_abst.png'):
    model_file = 'fig/model_raw_abst.png'
...
'''
/usr/bin/python2.7 /home/hcilab/Documents/OSS/sensors2018cnnhar/opp/learn_raw_abst.py
...
=================================================================
conv1d_1 (Conv1D)            (None, 584, 30)           90        
_________________________________________________________________
conv1d_2 (Conv1D)            (None, 583, 50)           3050      
_________________________________________________________________
conv1d_3 (Conv1D)            (None, 582, 100)          10100     
_________________________________________________________________
conv1d_4 (Conv1D)            (None, 581, 300)          60300     
_________________________________________________________________
conv1d_5 (Conv1D)            (None, 580, 500)          300500    
_________________________________________________________________
flatten_1 (Flatten)          (None, 290000)            0         
_________________________________________________________________
dense_1 (Dense)              (None, 2)                 580002    
_________________________________________________________________
dropout_1 (Dropout)          (None, 2)                 0         
=================================================================
Total params: 954,042
Trainable params: 954,042
