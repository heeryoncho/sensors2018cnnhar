...
This code learns UP position activity classification model using LOWER body sensors data.
'''
...
if not os.path.exists('fig/model_lower_up.png'):
    model_file = 'fig/model_lower_up.png'
...
'''
/usr/bin/python2.7 /home/hcilab/Documents/OSS/sensors2018cnnhar/opp/learn_lower_up.py
