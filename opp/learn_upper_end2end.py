...
This code learns End-to-End activity classification model using UPPER body sensors data.
'''
...
if not os.path.exists('fig/model_upper_end2end.png'):
    model_file = 'fig/model_upper_end2end.png'
...
'''
/usr/bin/python2.7 /home/hcilab/Documents/OSS/sensors2018cnnhar/opp/learn_upper_end2end.py
...
__________________________________________________________________________________________________
conv1d_1 (Conv1D)               (None, 215, 50)      150         input_1[0][0]                    
__________________________________________________________________________________________________
conv1d_4 (Conv1D)               (None, 107, 50)      200         input_1[0][0]                    
__________________________________________________________________________________________________
conv1d_7 (Conv1D)               (None, 71, 50)       250         input_1[0][0]                    
__________________________________________________________________________________________________
conv1d_2 (Conv1D)               (None, 214, 100)     10100       conv1d_1[0][0]                   
__________________________________________________________________________________________________
conv1d_5 (Conv1D)               (None, 53, 100)      15100       conv1d_4[0][0]                   
__________________________________________________________________________________________________
conv1d_8 (Conv1D)               (None, 23, 100)      20100       conv1d_7[0][0]                   
__________________________________________________________________________________________________
conv1d_3 (Conv1D)               (None, 213, 300)     60300       conv1d_2[0][0]                   
__________________________________________________________________________________________________
conv1d_6 (Conv1D)               (None, 26, 300)      90300       conv1d_5[0][0]                   
__________________________________________________________________________________________________
conv1d_9 (Conv1D)               (None, 7, 300)       120300      conv1d_8[0][0]                   
__________________________________________________________________________________________________
flatten_1 (Flatten)             (None, 63900)        0           conv1d_3[0][0]                   
__________________________________________________________________________________________________
flatten_2 (Flatten)             (None, 7800)         0           conv1d_6[0][0]                   
__________________________________________________________________________________________________
flatten_3 (Flatten)             (None, 2100)         0           conv1d_9[0][0]                   
__________________________________________________________________________________________________
concatenate_1 (Concatenate)     (None, 73800)        0           flatten_1[0][0]                  
                                                                 flatten_2[0][0]                  
                                                                 flatten_3[0][0]                  
__________________________________________________________________________________________________
dropout_1 (Dropout)             (None, 73800)        0           concatenate_1[0][0]              
__________________________________________________________________________________________________
dense_1 (Dense)                 (None, 4)            295204      dropout_1[0][0]                  
==================================================================================================
Total params: 612,004
Trainable params: 612,004
