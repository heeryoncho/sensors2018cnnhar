...
if not os.path.exists('fig/model_raw_down.png'):
    model_file = 'fig/model_raw_down.png'
...
'''
/usr/bin/python2.7 /home/hcilab/Documents/OSS/sensors2018cnnhar/opp/learn_raw_down.py
